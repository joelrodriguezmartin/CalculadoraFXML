...
public class CalculadoraController implements Initializable{
	...
	// como solo usaremos una property no creo un model sino que inicializo aqui mismo una
	DoubleProperty resultado = new SimpleDoubleProperty(0.0);
	//inicializo las cosas del fxml
	@FXML
	GridPane root;
	@FXML
	...
	private void onButtonAction(char c) {
		...
		resultadoLabel.setText(calculadora.getPantalla());
	}
